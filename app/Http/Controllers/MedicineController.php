...
class MedicineController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.Crud_Functions.Medicine_Details.create',compact('categorylist','medicine_type_list','medicine_unit_list','manufacturer_list','leaftype_list'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $Medicine_Details->expire_date_of_the_medicine = $request->expire_date_of_the_medicine;
