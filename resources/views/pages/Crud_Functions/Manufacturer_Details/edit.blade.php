        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header pb-0">
              <div class="card-body">
                <form action="{{route('Manufacturer_Details.update',$Manufacturer_Details->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row g-3">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control" name="manufacturer_name" value="{{ $Manufacturer_Details->manufacturer_name }}" type="text" autocomplete="off">
                  </div>
                  <!-- Manufacturer Name -->
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control" name="agent_national_id_card" type="text" value="{{ $Manufacturer_Details->agent_national_id_card }}" autocomplete="off">
                  </div>
                  <!-- Form Input End -->
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control" name="agent_mobile_number" value="{{ $Manufacturer_Details->agent_mobile_number }}" type="text" autocomplete="off">
                  </div>
                  <!-- Form Input End -->
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control" name="debit_balance" value="{{ $Manufacturer_Details->debit_balance }}" type="text" autocomplete="off">
                  </div>
                  <!-- Form Input End -->
