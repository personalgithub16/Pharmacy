    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="mb-0 badge badge-secondary" style="font-size:18px;">{{$Manufacturer_Details->manufacturer_name}}
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="mb-0 badge badge-secondary" style="font-size:18px;">
              {{$Manufacturer_Details->agent_national_id_card}}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="mb-0 badge badge-secondary" style="font-size:18px;">{{$Manufacturer_Details->agent_mobile_number}}
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="mb-0 badge badge-secondary" style="font-size:18px;">{{number_format((float)$total_balance , 2,
              '.', '');}}</p>
          </div>
        </div>
      </div>
