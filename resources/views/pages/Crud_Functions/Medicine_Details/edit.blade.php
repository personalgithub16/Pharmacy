        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header pb-0">
              <div class="card-body">
                <form action="{{route('Customer_Details.update',$Customer_Details->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row g-3">
                    <!-- Customer Name Form Input Start -->
                    <div class="col-md-12 mb-3">
                      <label class="form-label ">Customer Name</label>
                      <input class="form-control" name="customer_name" value="{{ $Customer_Details->customer_name }}" type="text" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="customer_email_address" type="email" value="{{ $Customer_Details->customer_email_address }}" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="phone_number" value="{{ $Customer_Details->phone_number }}" type="text" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="national_id_card" value="{{ $Customer_Details->national_id_card }}" type="text" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="birth_certificate" value="{{ $Customer_Details->birth_certificate }}" type="text" autocomplete="off">
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="address" value="{{ $Customer_Details->address }}" type="text" autocomplete="off">
                    </div>
                    <!--  Address Input End -->
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="city" value="{{ $Customer_Details->city }}" type="text" autocomplete="off">
                    </div>
                    <!--  City Input End -->
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="country" value="{{ $Customer_Details->country }}" type="text" autocomplete="off">
                    </div>
                    <!--  Country Input End -->
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="mobile_number" value="{{ $Customer_Details->mobile_number }}" type="text" autocomplete="off">
                    </div>
                    <!--  Mobile Input End -->
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="zipcode" value="{{ $Customer_Details->zipcode }}" type="text" autocomplete="off">
                    </div>
                    <!--  Zip Code Input End -->
                  ...
                  <button class="btn btn-primary btn-lg" type="submit">Edit Customer Information</button>
                </form>
              </div>
            </div>
          </div>
