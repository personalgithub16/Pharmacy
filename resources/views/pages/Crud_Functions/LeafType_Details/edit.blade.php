        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header pb-0">
              <div class="card-body">
                <form action="{{route('LeafType_Details.update',$LeafTypeDetails->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row g-3">
                    <!-- Form Input Start -->
                    <div class="col-md-12 mb-3">
                      <label class="form-label ">Category Name</label>
                      <input class="form-control" name="leaf_type" value="{{ $LeafTypeDetails->leaf_type }}" type="text" autocomplete="off">
                    </div>
                    <!-- Form Input End -->
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input class="form-control" name="total_number_per_box" value="{{ $LeafTypeDetails->total_number_per_box }}" type="text" autocomplete="off">
                    </div>
                    <!-- Form Input End -->
