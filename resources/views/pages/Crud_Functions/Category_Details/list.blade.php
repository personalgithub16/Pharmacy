      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Category List </h4>
            <span>
              <a href="{{route('Category_Details.create')}}"><button class="btn btn-outline-success-2x" type="button"
                  style="float: right;"><i class="fa-solid fa-plus"></i> Add New Category</button></a>
            </span>
          </div>
          <div class="card-body">
                    ...
                    <td>
                      <ul class="">
                        <div class="action_button" style="display:flex; justify-content:center">
                          <a href="{{route('Category_Details.edit' , $info->id)}}" class="custom_image"
                          ...
                          <a href="{{route('Category_Details.destroy', $info->id)}}" class="custom_image"
