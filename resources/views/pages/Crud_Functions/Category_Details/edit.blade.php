      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <div class="card-body">
              <form action="{{route('Category_Details.update',$CategoryDetails->id)}}" method="POST"
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control" name="category_name" value="{{ $CategoryDetails->category_name }}"
